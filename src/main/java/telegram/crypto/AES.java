...
//Classe temporanea che implenta AES IGE encrypt e decrypt metodo a 256 bit
//da studiare e da rimpiazzare successivamente con la mia
public class AES {
    ...
    private Cipher mInternalCipher;
    ...
    public AES(byte[] secretKeyRaw, byte[] ivRaw) {
        try {
