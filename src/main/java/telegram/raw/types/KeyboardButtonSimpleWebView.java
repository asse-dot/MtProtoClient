...
public class KeyboardButtonSimpleWebView extends TlObject {

    public static final int ID = -1598009252;
    ...
    public static KeyboardButtonSimpleWebView read(ByteArrayInputStream bytes) throws IOException {
