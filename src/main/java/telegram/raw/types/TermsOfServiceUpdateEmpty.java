...
public class TermsOfServiceUpdateEmpty extends TlObject {

    public static final int ID = -483352705;
    ...
    public static TermsOfServiceUpdateEmpty read(ByteArrayInputStream bytes) throws IOException {
