...
public class InputSecureValue extends TlObject {

    public static final int ID = -618540889;
    ...
    public InputSecureValue(TlObject type, TlObject data, TlObject front_side, TlObject reverse_side, TlObject selfie, ArrayList<TlObject> translation, ArrayList<TlObject> files, TlObject plain_data) {
        this.type = type;
		this.data = data;
    ...
    public static InputSecureValue read(ByteArrayInputStream bytes) throws IOException {
		...
		return new InputSecureValue(type, data, front_side, reverse_side, selfie, translation, files, plain_data);
    }
