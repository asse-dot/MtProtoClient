...
public class InputPeerUser extends TlObject {
    ...
    public static final int ID = -571955892;
    ...
    public static InputPeerUser read(ByteArrayInputStream bytes) throws IOException {
        long user_id = LongPrimitive.read(bytes).getValue();
		long access_hash = LongPrimitive.read(bytes).getValue();
		
		return new InputPeerUser(user_id, access_hash);
    }
