...
public class PaymentSavedCredentialsCard extends TlObject {

    public static final int ID = -842892769;
    ...
    public static PaymentSavedCredentialsCard read(ByteArrayInputStream bytes) throws IOException {
