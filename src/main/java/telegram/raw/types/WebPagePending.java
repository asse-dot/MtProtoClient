...
public class WebPagePending extends TlObject {

    public static final int ID = -981018084;
    ...
    public static WebPagePending read(ByteArrayInputStream bytes) throws IOException {
