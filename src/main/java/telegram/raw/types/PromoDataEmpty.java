...
public class PromoDataEmpty extends TlObject {

    public static final int ID = -1728664459;
    ...
    public static PromoDataEmpty read(ByteArrayInputStream bytes) throws IOException {
