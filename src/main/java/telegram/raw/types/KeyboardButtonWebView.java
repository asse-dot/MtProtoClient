...
public class KeyboardButtonWebView extends TlObject {

    public static final int ID = 326529584;

    public String text;
	public String url;

    public KeyboardButtonWebView(String text, String url) {
        this.text = text;
		this.url = url;
    }

    public static KeyboardButtonWebView read(ByteArrayInputStream bytes) throws IOException {
