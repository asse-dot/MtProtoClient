...
public class SendMessageUploadAudioAction extends TlObject {

    public static final int ID = -212740181;
    ...
    public static SendMessageUploadAudioAction read(ByteArrayInputStream bytes) throws IOException {
