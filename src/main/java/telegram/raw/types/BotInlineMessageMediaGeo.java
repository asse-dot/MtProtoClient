...
public class BotInlineMessageMediaGeo extends TlObject {

    public static final int ID = 85477117;
    ...
    public BotInlineMessageMediaGeo(TlObject geo, int heading, int period, int proximity_notification_radius, TlObject reply_markup) {
        this.geo = geo;
    ...
    public static BotInlineMessageMediaGeo read(ByteArrayInputStream bytes) throws IOException {
		...
		return new BotInlineMessageMediaGeo(geo, heading, period, proximity_notification_radius, reply_markup);
    }
