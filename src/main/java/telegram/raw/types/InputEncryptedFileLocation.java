...
public class InputEncryptedFileLocation extends TlObject {
    ...
    public static InputEncryptedFileLocation read(ByteArrayInputStream bytes) throws IOException {
        long id = LongPrimitive.read(bytes).getValue();
		long access_hash = LongPrimitive.read(bytes).getValue();
		
		return new InputEncryptedFileLocation(id, access_hash);
    }
