...
public class WebDocument extends TlObject {

    public static final int ID = 475467473;
    ...
    public WebDocument(String url, long access_hash, int size, String mime_type, ArrayList<TlObject> attributes) {
        this.url = url;
    ...
    public static WebDocument read(ByteArrayInputStream bytes) throws IOException {
		...
		return new WebDocument(url, access_hash, size, mime_type, attributes);
    }
