...
public class InputStickerSetID extends TlObject {

    public static final int ID = -1645763991;
    ...
    public static InputStickerSetID read(ByteArrayInputStream bytes) throws IOException {
        long id = LongPrimitive.read(bytes).getValue();
		long access_hash = LongPrimitive.read(bytes).getValue();
		
		return new InputStickerSetID(id, access_hash);
    }
