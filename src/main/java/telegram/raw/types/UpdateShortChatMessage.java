...
public class UpdateShortChatMessage extends TlObject {

    public static final int ID = 1299050149;
    ...
    public UpdateShortChatMessage(boolean out, boolean mentioned, boolean media_unread, boolean silent, int id, long from_id, long chat_id, String message, int pts, int pts_count, int date, TlObject fwd_from, long via_bot_id, TlObject reply_to, ArrayList<TlObject> entities, int ttl_period) {
        this.out = out;
    ...
    public static UpdateShortChatMessage read(ByteArrayInputStream bytes) throws IOException {
		...
		long from_id = LongPrimitive.read(bytes).getValue();
		...
		return new UpdateShortChatMessage(out, mentioned, media_unread, silent, id, from_id, chat_id, message, pts, pts_count, date, fwd_from, via_bot_id, reply_to, entities, ttl_period);
    }
    ...
    public byte[] write() throws IOException {
		...
		bOut.write(new LongPrimitive(this.from_id).write());
