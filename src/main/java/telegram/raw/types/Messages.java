...
public class Messages extends TlObject {
    ...
    public Messages(ArrayList<TlObject> messages, ArrayList<TlObject> chats, ArrayList<TlObject> users) {
        this.messages = messages;
		this.chats = chats;
		this.users = users;
    }

    public static Messages read(ByteArrayInputStream bytes) throws IOException {
