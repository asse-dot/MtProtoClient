...
public class InputGameID extends TlObject {

    public static final int ID = 53231223;
    ...
    public static InputGameID read(ByteArrayInputStream bytes) throws IOException {
        long id = LongPrimitive.read(bytes).getValue();
		long access_hash = LongPrimitive.read(bytes).getValue();
		
		return new InputGameID(id, access_hash);
    }
