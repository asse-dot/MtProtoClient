...
public class SendAsPeers extends TlObject {

    public static final int ID = -191450938;

    public ArrayList<TlObject> peers;
	public ArrayList<TlObject> chats;
	public ArrayList<TlObject> users;

    public SendAsPeers(ArrayList<TlObject> peers, ArrayList<TlObject> chats, ArrayList<TlObject> users) {
        this.peers = peers;
		this.chats = chats;
		this.users = users;
    }

    public static SendAsPeers read(ByteArrayInputStream bytes) throws IOException {
