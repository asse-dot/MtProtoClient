...
public class InputBotInlineMessageMediaContact extends TlObject {

    public static final int ID = -1494368259;
    ...
    public InputBotInlineMessageMediaContact(String phone_number, String first_name, String last_name, String vcard, TlObject reply_markup) {
    ...
    public static InputBotInlineMessageMediaContact read(ByteArrayInputStream bytes) throws IOException {
		...
		return new InputBotInlineMessageMediaContact(phone_number, first_name, last_name, vcard, reply_markup);
    }
