...
public class ToggleJoinRequest extends TlObject {

    public static final int ID = 1277789622;

    public TlObject channel;
	public TlObject enabled;

    public ToggleJoinRequest(TlObject channel, TlObject enabled) {
        this.channel = channel;
		this.enabled = enabled;
    }

    public static ToggleJoinRequest read(ByteArrayInputStream bytes) throws IOException {
