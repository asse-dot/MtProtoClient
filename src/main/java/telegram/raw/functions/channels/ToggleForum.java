...
public class ToggleForum extends TlObject {

    public static final int ID = -1540781271;

    public TlObject channel;
	public TlObject enabled;

    public ToggleForum(TlObject channel, TlObject enabled) {
        this.channel = channel;
		this.enabled = enabled;
    }

    public static ToggleForum read(ByteArrayInputStream bytes) throws IOException {
