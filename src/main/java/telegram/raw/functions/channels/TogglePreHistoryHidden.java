...
public class TogglePreHistoryHidden extends TlObject {

    public static final int ID = -356796084;

    public TlObject channel;
	public TlObject enabled;

    public TogglePreHistoryHidden(TlObject channel, TlObject enabled) {
        this.channel = channel;
		this.enabled = enabled;
    }

    public static TogglePreHistoryHidden read(ByteArrayInputStream bytes) throws IOException {
