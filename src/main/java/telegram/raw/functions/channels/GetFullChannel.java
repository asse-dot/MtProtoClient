...
public class GetFullChannel extends TlObject {
    ...
    public static final int ID = 141781513;

    public TlObject channel;

    public GetFullChannel(TlObject channel) {
        this.channel = channel;
    }

    public static GetFullChannel read(ByteArrayInputStream bytes) throws IOException {
