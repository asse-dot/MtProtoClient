...
public class GetChannels extends TlObject {
    ...
    public static final int ID = 176122811;

    public ArrayList<TlObject> id;

    public GetChannels(ArrayList<TlObject> id) {
        this.id = id;
    }

    public static GetChannels read(ByteArrayInputStream bytes) throws IOException {
