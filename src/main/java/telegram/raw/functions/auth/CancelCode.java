...
public class CancelCode extends TlObject {
    ...
    public static final int ID = 520357240;
    ...
    public static CancelCode read(ByteArrayInputStream bytes) throws IOException {
        String phone_number = StringPrimitive.read(bytes).getValue();
		String phone_code_hash = StringPrimitive.read(bytes).getValue();
		
		return new CancelCode(phone_number, phone_code_hash);
    }
