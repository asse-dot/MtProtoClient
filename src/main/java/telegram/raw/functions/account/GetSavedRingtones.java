...
public class GetSavedRingtones extends TlObject {

    public static final int ID = -510647672;
    ...
    public static GetSavedRingtones read(ByteArrayInputStream bytes) throws IOException {
