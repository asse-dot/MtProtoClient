...
public class SendEncryptedFile extends TlObject {
    ...
    public static final int ID = 1431914525;
    ...
    public SendEncryptedFile(boolean silent, TlObject peer, long random_id, byte[] data, TlObject file) {
        this.silent = silent;
		this.peer = peer;
    ...
    public static SendEncryptedFile read(ByteArrayInputStream bytes) throws IOException {
		...
		return new SendEncryptedFile(silent, peer, random_id, data, file);
    }
