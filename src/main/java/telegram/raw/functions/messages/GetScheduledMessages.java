...
public class GetScheduledMessages extends TlObject {

    public static final int ID = -1111817116;

    public TlObject peer;
	public ArrayList<TlObject> id;

    public GetScheduledMessages(TlObject peer, ArrayList<TlObject> id) {
        this.peer = peer;
		this.id = id;
    }

    public static GetScheduledMessages read(ByteArrayInputStream bytes) throws IOException {
