...
public class DeleteScheduledMessages extends TlObject {

    public static final int ID = 1504586518;

    public TlObject peer;
	public ArrayList<TlObject> id;

    public DeleteScheduledMessages(TlObject peer, ArrayList<TlObject> id) {
        this.peer = peer;
		this.id = id;
    }

    public static DeleteScheduledMessages read(ByteArrayInputStream bytes) throws IOException {
