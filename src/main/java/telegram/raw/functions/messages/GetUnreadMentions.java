...
public class GetUnreadMentions extends TlObject {

    public static final int ID = -251140208;
    ...
    public GetUnreadMentions(TlObject peer, int top_msg_id, int offset_id, int add_offset, int limit, int max_id, int min_id) {
        this.peer = peer;
    ...
    public static GetUnreadMentions read(ByteArrayInputStream bytes) throws IOException {
		...
		return new GetUnreadMentions(peer, top_msg_id, offset_id, add_offset, limit, max_id, min_id);
    }
