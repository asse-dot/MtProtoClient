...
public class GetHistory extends TlObject {
    ...
    public static final int ID = 1143203525;
    ...
    public GetHistory(TlObject peer, int offset_id, int offset_date, int add_offset, int limit, int max_id, int min_id, long hash) {
        this.peer = peer;
    ...
    public static GetHistory read(ByteArrayInputStream bytes) throws IOException {
		...
		return new GetHistory(peer, offset_id, offset_date, add_offset, limit, max_id, min_id, hash);
    }
