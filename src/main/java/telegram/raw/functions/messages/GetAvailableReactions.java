...
public class GetAvailableReactions extends TlObject {

    public static final int ID = 417243308;
    ...
    public static GetAvailableReactions read(ByteArrayInputStream bytes) throws IOException {
