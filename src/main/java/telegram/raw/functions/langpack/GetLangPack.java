...
public class GetLangPack extends TlObject {

    public static final int ID = -219008246;

    public String lang_pack;
	public String lang_code;

    public GetLangPack(String lang_pack, String lang_code) {
        this.lang_pack = lang_pack;
		this.lang_code = lang_code;
    }

    public static GetLangPack read(ByteArrayInputStream bytes) throws IOException {
        String lang_pack = StringPrimitive.read(bytes).getValue();
		String lang_code = StringPrimitive.read(bytes).getValue();
		
		return new GetLangPack(lang_pack, lang_code);
    }
